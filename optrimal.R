...
dir.create("/home/kris/bp_ceroxyloideae/best_alignments/optimal_final_results/")
file.copy(paste(optrim, '/', names(optrim), sep = ''), "/home/kris/bp_ceroxyloideae/best_alignments/optimal_final_results/")
